DELETE FROM `vollchi_api`.`doctor`;


INSERT INTO `vollchi_api`.`doctor` (`id`, `nombre`, `email`, `documento`, `speciality`, `calle`, `distrito`, `complemento`, `numero`, `ciudad`, `telefono`, `activo`)
