DELETE FROM `vollchi_api`.`medico`;


INSERT INTO `vollchi_api`.`medico` (`id`, `nombre`, `email`, `documento`, `especialidad`, `calle`, `distrito`, `complemento`, `numero`, `ciudad`, `telefono`, `activo`)
